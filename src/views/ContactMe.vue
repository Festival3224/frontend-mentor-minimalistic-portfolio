<template>
    <div class="max-w-[1110px] mx-auto">
        ...
        <div class="grid grid-cols-5 pt-12">
            <div class="col-span-2">
                <h1 class="hdr">Contact Me</h1>
            </div>
            <div class="col-span-3">
                <form class="pb-[100px]  mx-4" @submit.prevent="handleSubmit">
                        ...
                        <button class="btn w-[200px] h-12 block bg-portfolio-primary-blue text-portfolio-secondary-lightgrey ">send message</button>
                </form>
            </div>
        </div>


<!--         <hr class="w-[1110px] h-1 border-portfolio-secondary-grey my-16">
